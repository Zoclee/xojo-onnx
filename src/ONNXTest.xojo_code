...
Protected Module ONNXTest
	...
	#tag Method, Flags = &h21
		Private Sub TestModel(results As JSONItem)
		  ...
		  Model.Test_Operator_QLinearConv(results)
		  Model.Test_Operator_QuantizeLinear(results)
	...
	#tag Method, Flags = &h21
		Private Sub TestNode(results As JSONItem)
		  ...
		  Node.Test_Evaluate_QLinearConv(results)
		  Node.Test_Evaluate_QuantizeLinear(results)
	...
	#tag Method, Flags = &h21
		Private Sub TestTensor(results As JSONItem)
		  ...
		  Tensor.Test_QLinearConv(results)
