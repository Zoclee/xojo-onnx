...
Protected Module Model
	...
	#tag Method, Flags = &h1
		Protected Sub Test_Operator_Softmax(results As JSONItem)
		  Var pass As Boolean
		  Var input As new Dictionary()
		  Var output As Dictionary
		  Var X1 As ONNX.Tensor
		  ...
		  model = new ONNX.Model(App.TestFolder.Child("models").Child("operators").Child("softmax.onnx"))
		  ...
		  RecordTestResult(results, "Model: test/models/operators/softmax.onnx", pass)
	...
	#tag Method, Flags = &h1
		Protected Sub Test_Operator_Sqrt(results As JSONItem)
		  ...
		  model = new ONNX.Model(App.TestFolder.Child("models").Child("operators").Child("sqrt.onnx"))
		  
		  input.Value("input1") = new ONNX.Tensor(ONNX.ElementTypeEnum.FLOAT, "[[4.0, 9.0], [16.0, 25.0]]")
		  ...
		  RecordTestResult(results, "Model: test/models/operators/sqrt.onnx", pass)
	...
	#tag Method, Flags = &h1
		Protected Sub Test_Operator_Subtract(results As JSONItem)
		  Var pass As Boolean
		  Var input As new Dictionary()
		  Var output As Dictionary
		  Var X1 As ONNX.Tensor
		  ...
		  model = new ONNX.Model(App.TestFolder.Child("models").Child("operators").Child("subtract.onnx"))
		  
		  input.Value("input1") = new ONNX.Tensor(ONNX.ElementTypeEnum.FLOAT, "[[5.0, 8.0], [10.0, 3.0]]")
		  input.Value("input2") = new ONNX.Tensor(ONNX.ElementTypeEnum.FLOAT, "[[2.0, 3.0], [4.0, 1.0]]")
		  ...
		  RecordTestResult(results, "Model: test/models/operators/subtract.onnx", pass)
	...
	#tag Method, Flags = &h1
		Protected Sub Test_Operator_Tan(results As JSONItem)
		  Var pass As Boolean
		  Var input As new Dictionary()
		  Var output As Dictionary
		  Var X1 As ONNX.Tensor
		  ...
		  model = new ONNX.Model(App.TestFolder.Child("models").Child("operators").Child("tan.onnx"))
		  
		  input.Value("input1") = new ONNX.Tensor(ONNX.ElementTypeEnum.FLOAT, "[[0.0, 1.0], [-1.0, 0.5]]")
		  ...
		  RecordTestResult(results, "Model: test/models/operators/tan.onnx", pass)
	...
	#tag Method, Flags = &h1
		Protected Sub Test_Operator_Tanh(results As JSONItem)
		  Var pass As Boolean
		  Var input As new Dictionary()
		  Var output As Dictionary
		  Var X1 As ONNX.Tensor
		  ...
		  model = new ONNX.Model(App.TestFolder.Child("models").Child("operators").Child("tanh.onnx"))
		  ...
		  RecordTestResult(results, "Model: test/models/operators/tanh.onnx", pass)
